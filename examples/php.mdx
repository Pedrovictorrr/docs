---
title: 'Integração PHP'
description: 'Exemplos práticos de integração com o Manager SaaS usando PHP'
---

# Integração PHP - Manager SaaS

Exemplos práticos de como integrar sua aplicação PHP com a API do Manager SaaS para emissão de documentos fiscais eletrônicos.
...
class ManagerSaasClient
{
    ...
    public function __construct(array $config)
    {
        ...
        $this->httpClient = new Client([
            ...
            'headers' => [
                ...
                'User-Agent' => 'ManagerSaas-PHP-Client/1.0'
            ]
        ]);
        
        $this->logger = new Logger('manager_saas');
        $this->logger->pushHandler(new StreamHandler(storage_path('logs/manager_saas.log')));
    }
    ...
    public function emitirCTeOS(array $dados): array
    {
        try {
            ...
            $this->logger->info('CT-e OS emitido com sucesso', [
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
  >
    Veja exemplos em Node.js, Python e Java
  </Card>
  <Card
