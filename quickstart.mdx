...
description: 'Configure sua primeira integração com o Manager SaaS CT-e em minutos'
---

# Primeiros Passos - Manager SaaS CT-e

Configure sua primeira integração com o Manager SaaS CT-e em poucos minutos e comece a emitir Conhecimentos de Transporte Eletrônico.
...
## Passo 1: Autenticação e Obtenção de Token

### **1.1 Endpoint de Autenticação**

Para obter o token de autenticação, faça uma requisição para:
...
### **7.1 Configurações MODO**

Para personalizar o comportamento do sistema, utilize as configurações MODO:
...
### **7.2 Configurações de Certificado**
...
## Passo 8: Implementar em Produção
...
### **9.1 Carta de Correção Eletrônica**
...
<CardGroup cols={2}>
  <Card
    ...
    icon="file-text"
  >
    Conheça todos os detalhes sobre CT-e
  </Card>
  <Card
    title="Emissão CT-e OS"
    href="/documents/cte/os-emission"
    icon="clipboard-list"
  >
    Aprenda sobre emissão de CT-e OS
  </Card>
  <Card
    title="Autenticação"
...
🎉 **Parabéns!** Você configurou com sucesso sua integração com o Manager SaaS CT-e. Agora pode começar a emitir Conhecimentos de Transporte Eletrônico de forma automatizada e eficiente.
